module.exports = {
	...
	short_description: "Added option to check if a message delivery has failed.",
	...
	html: function(isEvent, data) {
		return `
	<div id="scrollbar" style="width: 550px; height: 350px; overflow-y: scroll;">
	...
	<div>
		...
		<div id="varNameContainer" style="float: right; width: 60%;">
			Action Number/Amount:<br>
			<input id="iffalseVal" class="round" type="text" list="variableList"><br>
		</div>
	Users can disable receiving Direct Messages from strangers in their privacy settings. You can specify what your bot should do in this case using the fields above.
	</div>`;
	},
	...
	action: function(cache) {
		...
		if(Array.isArray(target)) {
			...
			}.bind(this)).catch(err =>console.log('not this one yet. thxbai'));
